    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "TRNY10", "Tournament Master", new DateTime(2021, 4, 6, 15, 44, 41, 948, DateTimeKind.Local).AddTicks(2465), 10.99 },
                    { 2, "DRAFT10", "Draft Manager 2.0", new DateTime(2021, 4, 6, 15, 44, 41, 950, DateTimeKind.Local).AddTicks(6365), 5.9900000000000002 },
                    { 3, "TRNY20", "Tournament Master 2.0", new DateTime(2021, 4, 6, 15, 44, 41, 950, DateTimeKind.Local).AddTicks(6406), 12.99 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 3, 1, null, new DateTime(2021, 4, 6, 15, 44, 41, 951, DateTimeKind.Local).AddTicks(546), "Unknown error when attempting to open program", 1, 3, "Error while attempting to run program" });

            migrationBuilder.InsertData(
                table: "Incidents",
                columns: new[] { "IncidentId", "CustomerId", "DateClosed", "DateOpened", "Description", "ProductId", "TechnicianId", "Title" },
                values: new object[] { 2, 3, null, new DateTime(2021, 4, 6, 15, 44, 41, 951, DateTimeKind.Local).AddTicks(523), "Encountered compatability issues", 2, 3, "Error launching program" });

            migrationBuilder.InsertData(
                table: "Incidents",
                columns: new[] { "IncidentId", "CustomerId", "DateClosed", "DateOpened", "Description", "ProductId", "TechnicianId", "Title" },
                values: new object[] { 1, 2, null, new DateTime(2021, 4, 6, 15, 44, 41, 950, DateTimeKind.Local).AddTicks(9857), "Customer is having issues with installation on Win 10", 1, 3, "Could not install" });
